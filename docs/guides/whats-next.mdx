...
- [スタイルシート](../styling-layout.mdx)や [swizzling](../swizzling.mdx) を使って、サイトの外観をカスタマイズ。
- ページに、[画像やその他のアセットを挿入](../static-assets.mdx)。
- サイトに、[検索を追加](../search.mdx)。
- 標準 Docusaurus API を通じて、[ブラウザー対応](../browser-support.mdx)と [SEO](../seo.mdx) が、どのように行われるかを理解。
- [個々のプラグイン](../using-plugins.mdx)がどのようにインストールされ、設定されるかを理解。
- サイトをコンテンツ・ホストに[デプロイ](../deployment.mdx)。
- 複数の言語を含むようにサイトを[国際化](../i18n/i18n-tutorial.mdx)。
